...
<div class="grid">
      ...
      <div class="dropdown">
        <ul class="dropdown__list">
          ...
          <li class="dropdown__list-item">
            ...
            <span class="dropdown__title"><a href="/logout.php">log out</a></span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="main-header">
      <div class="main-header__intro-wrapper">
        <div class="main-header__welcome">
          <div class="main-header__welcome-title text-light">Welcome, <strong><?php echo $User->email; ?></strong></div>
        ...
        <div class="quickview">
          ...
          <div class="quickview__item">
            <div class="quickview__item-total">29&deg;</div>
            <div class="quickview__item-description">
              <i class="fas fa-map-marker-alt"></i>
              <span class="text-light">St. Vincent</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="footer">
    ...
    <div class="footer__signature">Made by Keron</div>
  </footer>
</div>
